...
(function(root, factory) {
  ...
  function checkCapabilities() {
    ...
    features.requestAnimationFrame =
      typeof features.requestAnimationFrameMethod === 'function';
  ...
  function setupPDF() {
    ...
    toArray(dom.wrapper.querySelectorAll(HORIZONTAL_SLIDES_SELECTOR)).forEach(function(
      hslide,
      h
    ) {
    ...
    // Show all fragments
    toArray(
      dom.wrapper.querySelectorAll(SLIDES_SELECTOR + ' .fragment')
  ...
  function createBackgrounds() {
    ...
    if (config.parallaxBackgroundImage) {
      dom.background.style.backgroundImage =
        'url("' + config.parallaxBackgroundImage + '")';
  ...
  function createBackground(slide, container) {
    ...
    if (data.background) {
      ...
      if (
        ...
        /\.(svg|png|jpg|jpeg|gif|bmp)([?#]|$)/gi.test(data.background)
      ) {
  ...
  function closestParent(target, selector) {
    ...
    while (parent) {
      ...
      var matchesMethod =
        parent.matches || parent.matchesSelector || parent.msMatchesSelector;
  ...
  function dispatchEvent(type, args) {
    ...
    if (config.postMessageEvents && window.parent !== window.self) {
      window.parent.postMessage(
        JSON.stringify({namespace: 'reveal', eventName: type, state: getState()}),
        '*'
      );
    }
  }
    ...
    if (features.transforms3d && !('msPerspective' in document.body.style)) {
      ...
      for (var i = 0, len = anchors.length; i < len; i++) {
        ...
        if (
          ...
          (!anchor.className || !anchor.classList.contains(anchor, 'roll'))
        ) {
  ...
  function getPreviousVerticalIndex(stack) {
    if (
      ...
      var attributeName = stack.hasAttribute('data-start-indexv')
        ? 'data-start-indexv'
  ...
  function layoutOverview() {
    ...
    toArray(dom.background.childNodes).forEach(function(hbackground, h) {
      transformElement(
        hbackground,
        'translate3d(' + h * overviewSlideWidth + 'px, 0, 0)'
      );

      toArray(hbackground.querySelectorAll('.slide-background')).forEach(function(
        vbackground,
        v
      ) {
        transformElement(
  ...
  function deactivateOverview() {
    ...
    if (config.overview) {
      ...
      toArray(dom.background.querySelectorAll('.slide-background')).forEach(function(
        background
      ) {
  ...
  function slide(h, v, f, o) {
    ...
    if (previousSlide) {
      ...
      if (dom.wrapper.querySelector(HOME_SLIDE_SELECTOR).classList.contains('present')) {
        ...
        setTimeout(function() {
          var slides = toArray(
              dom.wrapper.querySelectorAll(HORIZONTAL_SLIDES_SELECTOR + '.stack')
            ),
            i;
          for (i in slides) {
            if (slides[i]) {
  ...
  function updateSlidesVisibility() {
    ...
    if (horizontalSlidesLength && typeof indexh !== 'undefined') {
      ...
      for (var x = 0; x < horizontalSlidesLength; x++) {
        ...
        if (config.loop) {
          distanceX =
            Math.abs(((indexh || 0) - x) % (horizontalSlidesLength - viewDistance)) || 0;
        }
        ...
        if (verticalSlidesLength) {
          ...
          for (var y = 0; y < verticalSlidesLength; y++) {
            ...
            distanceY =
              x === (indexh || 0) ? Math.abs((indexv || 0) - y) : Math.abs(y - oy);
  ...
  function updateBackground(includeAll) {
    ...
    toArray(dom.background.childNodes).forEach(function(backgroundh, h) {
      ...
      if (includeAll || h === indexh) {
        toArray(backgroundh.querySelectorAll('.slide-background')).forEach(function(
          backgroundv,
          v
        ) {
    ...
    if (currentBackground) {
      ...
      var previousBackgroundHash = previousBackground
        ? previousBackground.getAttribute('data-background-hash')
        : null;
  ...
  function showSlide(slide) {
    ...
    toArray(
      slide.querySelectorAll('img[data-src], video[data-src], audio[data-src]')
    ...
    if (element && !isSpeakerNotes()) {
      ...
      toArray(element.querySelectorAll('video, audio')).forEach(function(el) {
        ...
        if (typeof autoplay !== 'boolean') {
          autoplay =
            el.hasAttribute('data-autoplay') || !!closestParent(el, '.slide-background');
        }
      ...
      if (isAttachedToDOM && isVisible) {
        ...
        if (typeof autoplay !== 'boolean') {
          autoplay =
            ...
            !!closestParent(iframe, '.slide-background');
        }
  ...
  function stopEmbeddedContent(element) {
    if (element && element.parentNode) {
      ...
      // YouTube postMessage API
      toArray(
        element.querySelectorAll('iframe[src*="youtube.com/embed/"]')
      ).forEach(function(el) {
        if (
      ...
      // Vimeo postMessage API
      toArray(
        element.querySelectorAll('iframe[src*="player.vimeo.com/"]')
      ).forEach(function(el) {
        if (
          !el.hasAttribute('data-ignore') &&
          el.contentWindow &&
  ...
  function getSlideBackground(x, y) {
    ...
    var horizontalBackground = dom.wrapper.querySelectorAll(
      '.backgrounds>.slide-background'
    )[x];
    var verticalBackgrounds =
      horizontalBackground && horizontalBackground.querySelectorAll('.slide-background');
  ...
  function setState(state) {
    if (typeof state === 'object') {
      slide(
        deserialize(state.indexh),
        deserialize(state.indexv),
        deserialize(state.indexf)
      );
    ...
    if (currentSlide && config.fragments) {
      ...
      if (fragments.length) {
        ...
        if (typeof index !== 'number') {
          var lastVisibleFragment = sortFragments(
  ...
  function cueAutoSlide() {
    ...
    if (currentSlide) {
      ...
      if (
        ...
        !isPaused() &&
        !isOverview() &&
        (!Reveal.isLastSlide() || availableFragments().next || config.loop === true)
      ) {
        autoSlideTimeout = setTimeout(function() {
          typeof config.autoSlideMethod === 'function'
      ...
      if (availableRoutes().up) {
        ...
        if (config.rtl) {
          previousSlide = toArray(
            dom.wrapper.querySelectorAll(HORIZONTAL_SLIDES_SELECTOR + '.future')
          ).pop();
        } else {
          previousSlide = toArray(
            dom.wrapper.querySelectorAll(HORIZONTAL_SLIDES_SELECTOR + '.past')
          ).pop();
        }
  ...
  function onDocumentKeyDown(event) {
    ...
    if (
      ...
      config.keyboardCondition() === false
    ) {
      return true;
    }
    ...
    // the keyboard
    var activeElementIsCE =
      document.activeElement && document.activeElement.contentEditable !== 'inherit';
    var activeElementIsInput =
      document.activeElement &&
      document.activeElement.tagName &&
      /input|textarea/i.test(document.activeElement.tagName);
    var activeElementIsNotes =
      document.activeElement &&
  ...
  function onProgressClicked(event) {
    ...
    var slidesTotal = toArray(dom.wrapper.querySelectorAll(HORIZONTAL_SLIDES_SELECTOR))
      .length;
  ...
  Reveal = {
    ...
    isLastSlide: function() {
      if (currentSlide) {
        ...
        if (isVerticalSlide(currentSlide) && currentSlide.parentNode.nextElementSibling)
          return false;
